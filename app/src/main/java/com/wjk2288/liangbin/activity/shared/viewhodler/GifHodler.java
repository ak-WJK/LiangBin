...
public class GifHodler extends RecyclerView.ViewHolder {
...
//    @Bind(R.id.gifimage)
//    GifImageView ivGifIcon;
        @Bind(R.id.iv_gif_icon)
    ImageView ivGifIcon;
    @Bind(R.id.tv_zan)
    TextView tvZan;
    @Bind(R.id.tv_cai)
    ...
    public GifHodler(View itemView) {
        super(itemView);
    ...
    public void setData(int position, List<RecommedBean.ListBean> datas, Context context) {
        ...
        String gifUrl = datas.get(position).getGif().getImages().get(0);
//        LogUtils.e("TAG", "gifurl" + gifUrl);
        Glide.with(context)
                .load(gifUrl)
