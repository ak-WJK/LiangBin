package com.wjk2288.testswitch;
...
public class MainActivity extends AppCompatActivity implements ViewSwitcher.ViewFactory {
    ...
    private void init() {
        ...
        switcher.setInAnimation(AnimationUtils.loadAnimation(this, R.anim.slide__in_bottom));
        switcher.setOutAnimation(AnimationUtils.loadAnimation(this, R.anim.slide__in_top));
    }
